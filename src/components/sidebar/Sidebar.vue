        ...
        >
            ...
            <div class="app-sidebar-float-submenu">
                <template v-for="menu in this.floatSubmenuMenu">
                    <sidebar-nav-list ref="sidebarNavList" v-bind:menu="menu" v-bind:key="menu.path" v-bind:status="menu.status" v-on:calc-float-submenu="handleCalcFloatSubmenu"></sidebar-nav-list>
                </template>
            </div>
        </div>
    </div>
