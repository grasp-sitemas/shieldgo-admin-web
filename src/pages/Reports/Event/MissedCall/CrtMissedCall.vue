...
export default {
    init: async payload => {
        setTimeout(async () => {
            ...
            payload.jsonFields = payload.JSON_FIELDS_CSV.missedEvents[payload.$i18n.locale].json_fields
            payload.jsonData = [payload.JSON_FIELDS_CSV.missedEvents[payload.$i18n.locale].json_data]
            payload.jsonMeta = [payload.JSON_FIELDS_CSV.missedEvents[payload.$i18n.locale].json_meta]
            payload.filename = payload.JSON_FIELDS_CSV.missedEvents[payload.$i18n.locale].filename
            payload.jsonTitle = payload.JSON_FIELDS_CSV.missedEvents[payload.$i18n.locale].title
            payload.pdfTitle = payload.JSON_FIELDS_CSV.missedEvents[payload.$i18n.locale].pdfTitle
