<template>
    <div>
        <h1 class="page-header">{{ $t('str.sidebar.menu.reports.incident.description') }}</h1>
        <hr />
...
export default {
    ...
    data() {
        return {
            ...
            jsonFields: JSON_FIELDS_CSV.incident.pt.json_fields,
            jsonData: [JSON_FIELDS_CSV.incident.pt.json_data],
            jsonMeta: [JSON_FIELDS_CSV.incident.pt.json_meta],
            filename: JSON_FIELDS_CSV.incident.pt.filename,
            jsonTitle: JSON_FIELDS_CSV.incident.pt.title,
            pdfTitle: JSON_FIELDS_CSV.incident.pt.pdfTitle,
    ...
    async created() {
        ...
        state.$registerEvent.$on('changeLanguage', function () {
            state.initTable()
            state.initRangeDate()
            state.jsonFields = JSON_FIELDS_CSV.incident[state.$i18n.locale].json_fields
            state.jsonData = [JSON_FIELDS_CSV.incident[state.$i18n.locale].json_data]
            state.jsonMeta = [JSON_FIELDS_CSV.incident[state.$i18n.locale].json_meta]
            state.filename = JSON_FIELDS_CSV.incident[state.$i18n.locale].filename
            state.jsonTitle = JSON_FIELDS_CSV.incident[state.$i18n.locale].title
            state.pdfTitle = JSON_FIELDS_CSV.incident.pt.pdfTitle
