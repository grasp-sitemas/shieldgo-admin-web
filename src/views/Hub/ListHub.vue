        ...
        <div class="col-xl-12">
            <div class="card-box">
                <div class="form-row">
                    <div class="col-md-11">
                        <p class="sub-header">
                            {{$t('string.msg.hub.search.description')}}
                        </p>
                    </div>
                ...
                <form>
                    ...
                    <div class="d-flex justify-content-end bd-highlight mb-3">
                        <download-excel v-if="items.length>0"
                        ...
                        <table class="table table-centered table-hover mb-0" id="datatable">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="border-top-0">{{$t('string.msg.question.table.label.type')}}</th>
                            ...
                            <tbody v-bind:key="item._id" v-for="item in pageOfItems" class="cursor-pointer" @click="selectItem(item)">
                                 <tr v-if="item && item.status == 'ACTIVE'">
                                    ...
                                    <td>
                                        <span v-if="item.type == 'TRICYCLE'">
                                            {{$t('string.msg.hub.type.tricycle')}}
                                        </span>
                                        <span v-if="item.type == 'ROLLON'">
                                            {{$t('string.msg.hub.type.rollon')}}
                                        </span>
                                        <span v-if="item.type == 'PEV'">
                                            {{$t('string.msg.hub.type.pev')}}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td v-if="isAdminMaster()">
                                        <span v-if="item.company && item.company.fantasyName">
                                            {{ toUpperCase(item.company.fantasyName) }}
                                        </span>
                                    </td>
                                </tr>
                            </tbody>
...
<script>
import Controller from './CrtListHub';
