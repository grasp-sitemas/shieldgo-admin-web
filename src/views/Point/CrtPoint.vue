    ...
    methods: {
        save: function () {
            ...
            Request.do(
                ...
                data,
                `${Endpoints.points.point}${this.data._id ? this.data._id : ''}`,
                pointResponse => {
                    //SUCCESS CALLBACK
                    this.errors = []
                    ...
                    this.$fire({
                        ...
                        this.data._id = pointResponse.result._id
                    })
                },
                error => {
                    //ERROR CALLBACK
        ...
        archive: function (response) {
            if (response == 1) {
                ...
                Request.do(
                    ...
                    Request.getDefaultHeader(this),
                    null,
                    `${Endpoints.points.point}${this.data._id}`,
                    companyResponse => {
                        //SUCCESS CALLBACK
        ...
        checkForm: function (e) {
            ...
            if (!this.data.project) {
                this.errors.push(this.$t('response.user.register.point.project.required'))
            }
            if (!this.data.name) {
            ...
            if (this.data.address.state == -1) {
                this.errors.push(this.$t('response.address.register.city.state.required'))
            }
            ...
            if (!this.data.address.neighborhood) {
                this.errors.push(this.$t('response.address.register.neighborhood.required'))
            }
        ...
        selectItem: function (item) {
            ...
            if (this.data.address && this.data.address.location && this.data.address.location.coordinates) {
            ...
            if (this.data.address && this.data.address.cep && this.data.address.cep.length == 9) {
                ...
                this.data.address.neighborhood = this.camelize(this.data.address.neighborhood)
