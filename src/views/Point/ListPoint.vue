    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card-box">
                <div class="form-row">
                    <div class="col-md-11">
                        <p class="sub-header">{{ $t('string.msg.point.list.label.title') }}</p>
                    </div>
                ...
                <form>
                    <div class="form-row">
                        <div class="m-0 form-group col-md-6">
                            ...
                            <multiselect v-model="filters.company" :options="companies" :close-on-select="true" track-by="_id" :custom-label="customLabelCompany" :searchable="true" placeholder="Selecione">
                            </multiselect>
                        </div>
